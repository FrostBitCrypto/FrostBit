...
// found in secure.cpp
const GENESIS_ACCOUNT: &str = "ice_3yjmdkzepbecr9a7xrhh5ibkdaecxj14xggywmzd3zwgn8npe3z95d1whkee";
const GENESIS_PRIVKEY: &str = "67E8B597EBA77FD2FDF38FB8EC85B960B93476164121BD6B1EA278DD534EDC17";
...
fn main() {
    env_logger::init();
    let matches = clap::App::new("frostbit-load-tester")
        ...
        .arg(
            Arg::with_name("tmp_dir")
                .long("tmp-dir")
                .value_name("PATH")
                .help("The path to a temporary directory for fstbt_node data"),
        )
        .arg(
            Arg::with_name("node_path")
                .value_name("PATH")
                .required(true)
                .help("The path to the fstbt_node to test"),
        )
        .arg(
