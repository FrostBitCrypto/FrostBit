...
public:
	...
	QPushButton * back;
	fstbt_qt::wallet & wallet;
};
class advanced_actions
{
public:
	advanced_actions (fstbt_qt::wallet &);
	QWidget * window;
	QVBoxLayout * layout;
...
{
public:
	block_creation (fstbt_qt::wallet &);
	void deactivate_all ();
	void activate_send ();
...
{
public:
	history (rai::ledger &, rai::account const &, fstbt_qt::wallet &);
	void refresh ();
	QWidget * window;
	QVBoxLayout * layout;
	QStandardItemModel * model;
...
{
public:
	account_viewer (fstbt_qt::wallet &);
	QWidget * window;
	QVBoxLayout * layout;
	QLabel * account_label;
...
{
public:
	status (fstbt_qt::wallet &);
	void erase (fstbt_qt::status_types);
	void insert (fstbt_qt::status_types);
	void set_text ();
	std::string text ();
	std::string color ();
	std::set<fstbt_qt::status_types> active;
	fstbt_qt::wallet & wallet;
};
class wallet : public std::enable_shared_from_this<fstbt_qt::wallet>
{
public:
	wallet (QApplication &, fstbt_qt::eventloop_processor &, rai::node &, std::shared_ptr<rai::wallet>, rai::account &);
	void start ();
	void refresh ();
	...
	fstbt_qt::history history;
	fstbt_qt::accounts accounts;
	fstbt_qt::self_pane self;
	fstbt_qt::settings settings;
	fstbt_qt::advanced_actions advanced;
	fstbt_qt::block_creation block_creation;
	fstbt_qt::block_entry block_entry;
	fstbt_qt::block_viewer block_viewer;
	fstbt_qt::account_viewer account_viewer;
	fstbt_qt::stats_viewer stats_viewer;
	fstbt_qt::import import;
