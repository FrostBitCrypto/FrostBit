...
// SI dividers
rai::uint128_t const Gfrost_ratio = rai::uint128_t ("1000000000000000000000000000000000"); // 10^33
rai::uint128_t const Mfrost_ratio = rai::uint128_t ("1000000000000000000000000000000"); // 10^30
rai::uint128_t const kfrost_ratio = rai::uint128_t ("1000000000000000000000000000"); // 10^27
rai::uint128_t const frost_ratio = rai::uint128_t ("1000000000000000000000000"); // 10^24
rai::uint128_t const mfrost_ratio = rai::uint128_t ("1000000000000000000000"); // 10^21
rai::uint128_t const ufrost_ratio = rai::uint128_t ("1000000000000000000"); // 10^18
