...
// SI dividers
rai::uint128_t const Gice_ratio = rai::uint128_t ("1000000000000000000000000000000000"); // 10^33
rai::uint128_t const Mice_ratio = rai::uint128_t ("1000000000000000000000000000000"); // 10^30
rai::uint128_t const kice_ratio = rai::uint128_t ("1000000000000000000000000000"); // 10^27
rai::uint128_t const ice_ratio = rai::uint128_t ("1000000000000000000000000"); // 10^24
rai::uint128_t const mice_ratio = rai::uint128_t ("1000000000000000000000"); // 10^21
rai::uint128_t const uice_ratio = rai::uint128_t ("1000000000000000000"); // 10^18
