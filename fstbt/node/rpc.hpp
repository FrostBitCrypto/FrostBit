...
public:
	...
	rai::node & node;
	bool on;
	static uint16_t const rpc_port = rai::fstbt_network == rai::fstbt_networks::fstbt_live_network ? 7076 : 55000;
};
...
public:
	...
	void key_expand ();
	void ledger ();
	void mrai_to_raw (rai::uint128_t = rai::Mfrost_ratio);
	void mrai_from_raw (rai::uint128_t = rai::Mfrost_ratio);
