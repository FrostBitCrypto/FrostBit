...
#include <fstbt/node/logging.hpp>
#include <fstbt/node/nodeconfig.hpp>
#include <fstbt/node/peers.hpp>
#include <fstbt/node/portmapping.hpp>
#include <fstbt/node/stats.hpp>
#include <fstbt/node/voting.hpp>
...
public:
	...
	static std::chrono::seconds constexpr search_pending_interval = (rai::fstbt_network == rai::fstbt_networks::fstbt_test_network) ? std::chrono::seconds (1) : std::chrono::seconds (5 * 60);
};
class thread_runner
{
public:
